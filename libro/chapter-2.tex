...
Es un sistema operativo resultante de décadas de colaboración entre decenas de miles de desarrolladores/as y cientos de empresas. 

Los dos proyectos principales que forman este sistema operativo son GNU y el kernel de Linux:
...
\begin{itemize}
    ...
    \item \textbf{Gentoo}: Sistema muy liberal en cuanto a lo que puedes hacer con él. Es muy configurable.
\end{itemize}